...
class ScraperEuroBydleni(ScraperBase):
    ...
    def build_response(self) -> requests.Response:
        request_data = {
            ...
            "sql[estate_area_min]": "",
            "sql[estate_area_max]": "",
            "sql[locality][locality][input]": self.location.search_label,
            "sql[locality][locality][city]": self.location.search_label,
            "sql[locality][locality][zip_code]": "",
            "sql[locality][locality][types]": "locality",
            "sql[locality][location][lat]": self.location.center_lat,
            "sql[locality][location][lng]": self.location.center_lng,
            "sql[locality][viewport][south]": self.location.south,
            "sql[locality][viewport][west]": self.location.west,
            "sql[locality][viewport][north]": self.location.north,
            "sql[locality][viewport][east]": self.location.east,
            "sql[poptavka][jmeno]": "",
