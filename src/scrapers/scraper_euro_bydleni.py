...
class ScraperEuroBydleni(ScraperBase):
    ...
    def build_response(self) -> requests.Response:
        request_data = {
            ...
            "sql[estate_area_min]": "",
            "sql[estate_area_max]": "",
            "sql[locality][locality][input]": "Praha, Česko",
            "sql[locality][locality][city]": "Praha, Česko",
            "sql[locality][locality][zip_code]": "",
            "sql[locality][locality][types]": "locality",
            "sql[locality][location][lat]": "50.0874654",
            "sql[locality][location][lng]": "14.4212535",
            "sql[locality][viewport][south]": "49.9419006",
            "sql[locality][viewport][west]": "14.2244355",
            "sql[locality][viewport][north]": "50.1774302",
            "sql[locality][viewport][east]": "14.7067867",
            "sql[poptavka][jmeno]": "",
